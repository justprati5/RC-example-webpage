...
```{r}
library(readxl)
nema2 <- read_excel("data/Nematode_Data.xlsx")
head(nema2)
```
...
```{r}
library(gsheet)
nema3 <- gsheet2tbl('https://docs.google.com/spreadsheets/d/1ElWVdgeAQb-uLDQUna3IBVWbnhWkgfL26J7-I8oh9oQ/edit?usp=sharing')
```
